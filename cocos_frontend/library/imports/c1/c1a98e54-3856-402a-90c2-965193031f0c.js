"use strict";
cc._RF.push(module, 'c1a985UOFZAKpDCllGTAx8M', 'dfinity-agent-prod');
// Script/Lib/dfinity-agent-prod.js
    ...
    "node_modules/@dfinity/candid/lib/cjs/idl.js": function node_modulesDfinityCandidLibCjsIdlJs(exports) {
      ...
      var RecordClass = /*#__PURE__*/function (_ConstructType3) {
        ...
        _proto25.decodeValue = function decodeValue(b, t) {
          ...
          for (var _iterator4 = _createForOfIteratorHelperLoose(this._fields.slice(expectedRecordIdx)), _step4; !(_step4 = _iterator4()).done;) {
            var _step4$value = _step4.value,
                _expectKey = _step4$value[0],
                _expectType = _step4$value[1];
      ...
      var TupleClass = /*#__PURE__*/function (_RecordClass2) {
        ...
        _proto26.decodeValue = function decodeValue(b, t) {
          ...
          for (var _iterator5 = _createForOfIteratorHelperLoose(tuple._components.entries()), _step5; !(_step5 = _iterator5()).done;) {
            var _step5$value = _step5.value,
                i = _step5$value[0],
                wireType = _step5$value[1];
      ...
      var VariantClass = /*#__PURE__*/function (_ConstructType4) {
        ...
        _proto27.decodeValue = function decodeValue(b, t) {
          ...
          for (var _iterator6 = _createForOfIteratorHelperLoose(this._fields), _step6; !(_step6 = _iterator6()).done;) {
            var _step6$value = _step6.value,
                key = _step6$value[0],
                expectType = _step6$value[1];
            ...
            case -20:
              {
                ...
                for (var _iterator8 = _createForOfIteratorHelperLoose(entry[1]), _step8; !(_step8 = _iterator8()).done;) {
            ...
            case -23:
              {
                ...
                for (var _iterator10 = _createForOfIteratorHelperLoose(methods), _step10; !(_step10 = _iterator10()).done;) {
                  var _step10$value = _step10.value,
                      _name2 = _step10$value[0],
                      typeRef = _step10$value[1];
  ...
  var require_relative = __commonJS({
    "node_modules/@dfinity/agent/node_modules/iso-url/src/relative.js": function node_modulesDfinityAgentNode_modulesIsoUrlSrcRelativeJs(exports, module) {
      ...
      module.exports = function (url, location, protocolMap, defaultProtocol) {
        ...
        var protocol = location.protocol ? location.protocol.replace(":", "") : "http";
    ...
    "node_modules/@dfinity/agent/node_modules/borc/src/encoder.js": function node_modulesDfinityAgentNode_modulesBorcSrcEncoderJs(exports, module) {
      ...
      var Encoder = /*#__PURE__*/function () {
        ...
        _proto48._pushSet = function _pushSet(gen, obj) {
          ...
          for (var _iterator12 = _createForOfIteratorHelperLoose(obj), _step12; !(_step12 = _iterator12()).done;) {
            var x = _step12.value;
    ...
    "node_modules/simple-cbor/src/serializer.js": function node_modulesSimpleCborSrcSerializerJs(exports) {
          ...
          switch (typeof value) {
            ...
            case "object":
              if (value === null) {
                ...
                for (var _iterator13 = _createForOfIteratorHelperLoose(value.entries()), _step13; !(_step13 = _iterator13()).done;) {
      ...
      var CborSerializer = /*#__PURE__*/function () {
        ...
        _proto53.removeEncoder = function removeEncoder(name) {
          for (var _iterator14 = _createForOfIteratorHelperLoose(this._encoders.values()), _step14; !(_step14 = _iterator14()).done;) {
            var encoder = _step14.value;
        ...
        _proto53.getEncoderFor = function getEncoderFor(value) {
          ...
          for (var _iterator15 = _createForOfIteratorHelperLoose(this._encoders), _step15; !(_step15 = _iterator15()).done;) {
      ...
      var SelfDescribeCborSerializer = /*#__PURE__*/function (_CborSerializer) {
        ...
        _proto54.serialize = function serialize(value) {
          ...
          return cbor.raw(_CborSerializer.prototype.serializeValue.call(this, value));
        };
      ...
      function createHasher(Point, mapToCurve, defaults) {
        ...
        return {
          ...
          mapToCurve: function mapToCurve(scalars) {
            ...
            for (var _iterator16 = _createForOfIteratorHelperLoose(scalars), _step16; !(_step16 = _iterator16()).done;) {
              var i = _step16.value;
        ...
        _tlv: {
          ...
          decode: function decode(tag, data) {
            ...
            if (!isLong) length = first;else {
              ...
              for (var _iterator17 = _createForOfIteratorHelperLoose(lengthBytes), _step17; !(_step17 = _iterator17()).done;) {
                var b = _step17.value;
                length = length << 8 | b;
              }
    ...
    "node_modules/@noble/curves/abstract/bls.js": function node_modulesNobleCurvesAbstractBlsJs(exports) {
      ...
      function createBlsPairing(fields, G1, G2, params) {
        ...
        var calcPairingPrecomputes = (0, utils_ts_1.memoized)(function (point) {
          ...
          for (var _iterator18 = _createForOfIteratorHelperLoose(ATE_NAF), _step18; !(_step18 = _iterator18()).done;) {
            var bit = _step18.value;
            var cur = [];
        ...
        function millerLoopBatch(pairs, withFinalExponent) {
          ...
          if (pairs.length) {
            ...
            for (var i = 0; i < ellLen; i++) {
              ...
              for (var _iterator19 = _createForOfIteratorHelperLoose(pairs), _step19; !(_step19 = _iterator19()).done;) {
                var _step19$value = _step19.value,
                    ell = _step19$value[0],
                    Px = _step19$value[1],
                    Py = _step19$value[2];

                for (var _iterator20 = _createForOfIteratorHelperLoose(ell[i]), _step20; !(_step20 = _iterator20()).done;) {
        ...
        function pairingBatch(pairs, withFinalExponent) {
          ...
          for (var _iterator21 = _createForOfIteratorHelperLoose(pairs), _step21; !(_step21 = _iterator21()).done;) {
      ...
      function createBlsSig(blsPairing, PubCurve, SigCurve, SignatureCoder, isSigG1) {
        ...
        return {
          ...
          verifyBatch: function verifyBatch(signature, messages, publicKeys) {
            ...
            try {
              for (var _iterator22 = _createForOfIteratorHelperLoose(messagePubKeyMap), _step22; !(_step22 = _iterator22()).done;) {
                var _step22$value = _step22.value,
                    _msg = _step22$value[0],
                    _keys = _step22$value[1];
    ...
    "node_modules/@dfinity/agent/lib/cjs/utils/expirableMap.js": function node_modulesDfinityAgentLibCjsUtilsExpirableMapJs(exports) {
      ...
      var ExpirableMap = /*#__PURE__*/function () {
        ...
        _proto71.prune = function prune() {
          ...
          for (var _iterator23 = _createForOfIteratorHelperLoose(__classPrivateFieldGet(this, _ExpirableMap_inner, "f").entries()), _step23; !(_step23 = _iterator23()).done;) {
            var _step23$value = _step23.value,
                key = _step23$value[0],
                entry = _step23$value[1];
        ...
        _proto71.entries = function entries() {
          ...
          var generator = /*#__PURE__*/_regeneratorRuntime().mark(function generator() {
            var _iterator24, _step24, _step24$value, key, value;

            return _regeneratorRuntime().wrap(function generator$(_context13) {
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    _iterator24 = _createForOfIteratorHelperLoose(iterator);
                  ...
                  case 1:
                    ...
                    _step24$value = _step24.value, key = _step24$value[0], value = _step24$value[1];
                    _context13.next = 5;
        ...
        _proto71.forEach = function forEach(callbackfn, thisArg) {
          for (var _iterator26 = _createForOfIteratorHelperLoose(__classPrivateFieldGet(this, _ExpirableMap_inner, "f").entries()), _step26; !(_step26 = _iterator26()).done;) {
    ...
    "node_modules/@dfinity/agent/lib/cjs/agent/http/index.js": function node_modulesDfinityAgentLibCjsAgentHttpIndexJs(exports) {
      ...
      function determineHost(configuredHost) {
        ...
        if (configuredHost !== void 0) {
          ...
          var location = typeof window !== "undefined" ? window.location : void 0;
          var hostname = location === null || location === void 0 ? void 0 : location.hostname;
          var knownHost;
      ...
      var HttpAgent = /*#__PURE__*/function () {
        ...
        function _HttpAgent(options) {
          ...
          _HttpAgent_verifyQueryResponse.set(this, function (queryResponse, subnetStatus) {
            ...
            for (var _iterator27 = _createForOfIteratorHelperLoose(signatures), _step27; !(_step27 = _iterator27()).done;) {
              var sig = _step27.value;
            ...
            return _regeneratorRuntime().wrap(function _callee16$(_context19) {
              while (1) {
                switch (_context19.prev = _context19.next) {
                  ...
                  case 31:
                    transformedRequest = _context19.sent;
                    body = cbor.encode(transformedRequest.body); // Ensure body is Uint8Array for fetch compatibility
        ...
        _proto76.query = /*#__PURE__*/function () {
          var _query = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(canisterId, fields, identity) {
            ...
            var _a, _b, _c, _d, backoff, ecid, transformedRequest, queryResult, id, canister, sender, request, requestId, body, u8, args, makeQuery, getSubnetStatus, _yield$Promise$all, _queryResult, subnetStatus, _queryResult2, requestDetails, _query2, queryWithDetails, updatedSubnetStatus, message, queryError;
            ...
            return _regeneratorRuntime().wrap(function _callee19$(_context22) {
              while (1) {
                switch (_context22.prev = _context22.next) {
                  ...
                  case 21:
                    transformedRequest = _context22.sent;
                    body = cbor.encode(transformedRequest.body); // Debug logging

                    if (body) {
                      u8 = new Uint8Array(body);
                      console.log("CBOR Body Length:", u8.length);
                      console.log("CBOR First 10 bytes:", Array.from(u8.slice(0, 10)).map(function (b) {
                ...
                switch (_context24.prev = _context24.next) {
                  case 0:
                    getRequestId = function _getRequestId(fields2) {
                      for (var _iterator28 = _createForOfIteratorHelperLoose(fields2.paths), _step28; !(_step28 = _iterator28()).done;) {
        ...
        _proto76._transform = function _transform(request) {
          ...
          if (request.endpoint === "call") {
            ...
            for (var _iterator29 = _createForOfIteratorHelperLoose(__classPrivateFieldGet(this, _HttpAgent_updatePipeline, "f")), _step29; !(_step29 = _iterator29()).done;) {
              _loop();
            }
          } else {
            ...
            for (var _iterator30 = _createForOfIteratorHelperLoose(__classPrivateFieldGet(this, _HttpAgent_queryPipeline, "f")), _step30; !(_step30 = _iterator30()).done;) {
              _loop2();
            }
          }
      ...
      function chain() {
        ...
        return /*#__PURE__*/function () {
          var _ref114 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee37(canisterId, requestId, status) {
            var _iterator31, _step31, a;

            return _regeneratorRuntime().wrap(function _callee37$(_context40) {
              while (1) {
                switch (_context40.prev = _context40.next) {
                  case 0:
                    _iterator31 = _createForOfIteratorHelperLoose(strategies);

                  case 1:
                    if ((_step31 = _iterator31()).done) {
                      _context40.next = 7;
                      break;
                    }
        ...
        _Actor.createActorClass = function createActorClass(interfaceFactory, options) {
          ...
          var CanisterActor = /*#__PURE__*/function (_Actor2) {
            ...
            function CanisterActor(config) {
              ...
              for (var _iterator32 = _createForOfIteratorHelperLoose(service._fields), _step32; !(_step32 = _iterator32()).done;) {
                var _step32$value = _step32.value,
                    methodName = _step32$value[0],
                    func = _step32$value[1];
